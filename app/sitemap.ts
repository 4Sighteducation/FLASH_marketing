...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: 'https://fl4shcards.com/subjects/sciences',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.7,
    },
    {
      url: 'https://fl4shcards.com/subjects/english',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.7,
    },
    ...
    {
      url: 'https://fl4shcards.com/subjects/languages',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.65,
    },
    {
      url: 'https://fl4shcards.com/subjects/business-and-it',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.65,
    },
